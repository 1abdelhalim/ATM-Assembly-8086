...
.DATA
    ...
    ;Account number
    ACC_MSG DB 0AH, " Enter your account number: $"
    ...
    ;Password data
    PWD_MSG DB 0AH, 0DH, " Enter your password: $"
    ...
    LIM_EXCEED DB 0AH, 0AH, 0DH, " Limit exceeded (Maximum amount =  5000)$"
       
    ;Balance
    CUR_BAL DW 20000
    CUR_BAL_MSG DB 0AH, 0AH, 0DH, " Current balance =  $"
    
    ;Withdraw
    WITH_PROMPT DB 0AH, 0AH, 0DH, " Enter amount to withdraw:  $"
    WITH_AMT DW 0H 
    BAL_LOW DB 0AH, 0AH, 0DH, " Insufficient balance$"
    
    ;Deposit
    DEP_PROMPT DB 0AH, 0AH, 0DH, " Enter amount to deposit:  $"
    DEP_AMT DW 0H
            
    ;Amount options
    ABOVE1000 DB 0AH, 0AH, 0DH, " 1. 1000 - 5000$"
    ABOVE100 DB 0AH, 0DH, " 2. 100 - 999$" 
    MAX_LIM DW 5000
    MIN_LIM DW 100
